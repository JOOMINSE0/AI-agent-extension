...
function getCfg() {
    ...
    return {
        ...
        wF: cfg.get("aiApproval.weights.functionality") ?? 0.40, // SF 가중치
        wR: cfg.get("aiApproval.weights.resource") ?? 0.30, // SR 가중치
        wD: cfg.get("aiApproval.weights.dependability") ?? 0.30 // SD 가중치
    };
}
