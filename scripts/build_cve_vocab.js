...
// ------------------ 1) CVE 파일 읽기 ------------------
function loadCveDocsFromDir(dir) {
    ...
    for (const f of files) {
        try {
            ...
            if (obj?.containers?.cna?.descriptions) {
                desc = obj.containers.cna.descriptions.map((d) => d.value || "").join(" ");
            }
...
function buildSignature(label, docs, TFs, IDF, docFilter, topK = 30) {
...
main();
//# sourceMappingURL=build_cve_vocab.js.map